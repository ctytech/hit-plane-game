...
public class Hero extends FlyingObject{
	...
	public boolean hit(FlyingObject other){
		...
		int x1 = other.x - this.width/4;                 //x坐标最小距离
		int x2 = other.x + this.width/4 + other.width;   //x坐标最大距离
		int y1 = other.y - this.height/4;                //y坐标最小距离
		int y2 = other.y + this.height/4 + other.height; //y坐标最大距离
